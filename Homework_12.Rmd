...
n1 <- ggplot(n2o.avg.m) +
  ...
  labs(y=expression(paste(N[2],"O flux (nmol ",N[2],"O-N ",m^-2," ",sec^-1,")"))) +
...
m1 <- ggplot(ch4.avg.m) +
  ...
  scale_x_date(date_breaks = "1 month", date_labels = "%b") +
  geom_vline(aes(xintercept = as.numeric(as.Date("2023-10-05"))),linetype=2) +
  labs(y=expression(paste(CH[4], " flux (nmol ",CH[4],"-C ",m^-2," ",sec^-1,")"))) +
  theme(axis.title.y = element_text(size=6)) +
  theme(axis.title.x=element_blank(),axis.text.x=element_blank()) +
...
c1 <- ggplot(co2.avg.m) +
  ...
  scale_x_date(date_breaks = "1 month", date_labels = "%b") +
  geom_vline(aes(xintercept = as.numeric(as.Date("2023-10-05"))),linetype=2) +
  labs(y=expression(paste(CO[2]," flux (umol ",CO[2],"-C ",m^-2," ",sec^-1,")"))) +
  theme(axis.title.y = element_text(size=6)) +
  theme(axis.title.x=element_blank(),axis.text.x=element_blank()) +
  scale_color_manual(values=my_cols) +
